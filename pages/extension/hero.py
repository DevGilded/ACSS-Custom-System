...
class HOME:
    def __init__(self, master: tk.Frame) -> None:
        icon = opkSVG.ToPNG('assets/svg/Homes-icon.svg', 1.5)

        self.Widgets = {
            'TitleLbl': opk.Title(master, text='CITE Members\' Specialization Data',
                                  description='Association of Computer Science Students', font=('Futura Hv BT', 18)),
...
class MEMBER:
    def __init__(self, master: tk.Frame) -> None:
        ...
        self.Widgets = {
            ...
            'IDBtn': opk.Button(master, text='ID', font=('Futura Bk BT', 14), width=10, radius=20,
                                background=PRIMARY_COLOR, foreground=BLANK, activeforeground=BLANK),
            'NameBtn': opk.Button(master, text='Name', font=('Futura Bk BT', 14), width=10, radius=20,
                                  background=PRIMARY_COLOR, foreground=BLANK, activeforeground=BLANK),
